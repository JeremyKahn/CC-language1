...
const I18N = (() => {
  const EN = {
    ...
    "reading.practiceIntro": "I'll read each sentence — repeat it after me. You get three tries per sentence.",
    "reading.practiceSentence": "Sentence {i} of {n}",
    "reading.practiceTryAgain": "🤔 {pct}% — not quite. Listen and try again.",
    "reading.practiceSlow": "🤔 {pct}% — not quite. Now listen slowly and try once more.",
    "reading.practiceGood": "✅ {pct}% — well repeated!",
    "reading.practiceMoveOn": "↷ {pct}% — let's move on to the next sentence.",
    "reading.practiceDone": "Practice complete! 🎉",
    "reading.sumSatisfactory": "Sentences repeated satisfactorily: {pct}% ({pass} of {total})",
    "reading.sumOverall": "Overall average match (best attempt per sentence): {pct}%",
    "reading.sumTry": "Average match on attempt {k}: {pct}% (over {count} sentence(s))",
  ...
  const FR = {
    ...
    "reading.practiceIntro": "Je lis chaque phrase — répétez-la après moi. Vous avez trois essais par phrase.",
    "reading.practiceSentence": "Phrase {i} sur {n}",
    "reading.practiceTryAgain": "🤔 {pct}% — pas tout à fait. Réécoutez et réessayez.",
    "reading.practiceSlow": "🤔 {pct}% — pas tout à fait. Écoutez maintenant lentement et réessayez.",
    "reading.practiceGood": "✅ {pct}% — bien répété !",
    "reading.practiceMoveOn": "↷ {pct}% — passons à la phrase suivante.",
    "reading.practiceDone": "Exercice terminé ! 🎉",
    "reading.sumSatisfactory": "Phrases répétées de façon satisfaisante : {pct}% ({pass} sur {total})",
    "reading.sumOverall": "Correspondance moyenne globale (meilleur essai par phrase) : {pct}%",
    "reading.sumTry": "Correspondance moyenne à l'essai {k} : {pct}% (sur {count} phrase(s))",
