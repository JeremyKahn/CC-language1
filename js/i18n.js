...
const I18N = (() => {
  const EN = {
    ...
    "drills.choices": "Number of choices",
    ...
    // drills — built-in wordlists
    "drills.biNouns": "Nouns",
    "drills.biAdjectives": "Adjectives",
    "drills.biAdverbs": "Adverbs",
    "drills.biVerbs": "Verbs",
    "drills.builtinShort": "built-in, by frequency",
    "drills.biBatchLbl": "batch",
    "drills.biLoading": "loading…",
    "drills.biUnavail": "unavailable",
    "drills.biLoadFail": "Could not load the built-in wordlist: {msg}",
  ...
  const FR = {
    ...
    "drills.choices": "Nombre de choix",
    ...
    "drills.biNouns": "Noms",
    "drills.biAdjectives": "Adjectifs",
    "drills.biAdverbs": "Adverbes",
    "drills.biVerbs": "Verbes",
    "drills.builtinShort": "intégrée, par fréquence",
    "drills.biBatchLbl": "lot",
    "drills.biLoading": "chargement…",
    "drills.biUnavail": "indisponible",
    "drills.biLoadFail": "Impossible de charger la liste intégrée : {msg}",
